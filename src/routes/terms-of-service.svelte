...
<Intro title="Terms of Service Dropzone Plus">
  ...
  <p>
    ...
    use Dropzone if you do not agree to take all of the terms and conditions stated on this page.
  </p>
</Intro>
...
<ContentSection backgroundColor="white">
  ...
  <p>
    Unless otherwise stated, Dropzone and/or its licensors own the intellectual property rights for
    all material on Dropzone. All intellectual property rights are reserved. You may access this
    from Dropzone for your own personal use subjected to restrictions set in these terms and
    conditions.
  </p>
  ...
  <ul>
    ...
    <li>Violence</li>
    <li>
      Distrimination against women, people of color, minorities, people with disabilities, the
      LGBTQA+ community
    </li>
  </ul>
  ...
  <p>
    ...
    hyperlink compensates the absence of Dropzone; and (d) the link is in the context of general
  ...
  <p>
    ...
    our website, you must inform us by sending an e-mail to Dropzone. Please include your name, your
  ...
  <p>
    No use of Dropzone's logo or other artwork will be allowed for linking absent a trademark
    license agreement.
  </p>
