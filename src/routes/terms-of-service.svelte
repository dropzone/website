...
<Intro title="Terms of Service Dropzone Plus">
  <p>
    ...
    Dropzone Plus' service, located at https://plus.dropzone.dev.
  </p>
  <p>
    By accessing this website we assume you accept these terms and conditions.
    Do not continue to use Dropzone if you do not agree to take all of the terms
...
<ContentSection backgroundColor="white">
  <p>
    ...
    of Netherlands. Any use of the above terminology or other words in the
  ...
  <p>
    Unless otherwise stated, Dropzone and/or its licensors own the intellectual
    property rights for all material on Dropzone. All intellectual property
    rights are reserved. You may access this from Dropzone for your own personal
    use subjected to restrictions set in these terms and conditions.
  </p>

  <p>You must not:</p>
  <ul>
    <li>Republish material from Dropzone</li>
    <li>Sell, rent or sub-license material from Dropzone</li>
    <li>Reproduce, duplicate or copy material from Dropzone</li>
    <li>Redistribute content from Dropzone</li>
  </ul>

  <h2>Dropzone Plus conditions</h2>

  <p>
    You are prohibited to use Dropzone Plus for content that violates our code
    of ethics.
  </p>

  <p>
    Content that is in contrast with our ethics includes (but is not limited
    to):
  </p>
  ...
  <ul>
    ...
    <li>Violence</li>
    <li>
      Distrimination against women, people of color, minorities, people with
      disabilities, the LGBTQA+ community
    </li>
  </ul>

  <p>
    We reserve the right to end any subscription if it violates our terms of
    service, code of conduct or ethics.
  </p>
  ...
  <p>
    ...
    compensates the absence of Dropzone; and (d) the link is in the context of
  ...
  <p>
    ...
    e-mail to Dropzone. Please include your name, your organization name,
  ...
  <p>
    No use of Dropzone's logo or other artwork will be allowed for linking
