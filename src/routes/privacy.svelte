...
<Intro title="Privacy Policy for Dropzone">
  <p>
    At Dropzone, accessible at https://www.dropzone.dev and
    https://plus.dropzone.dev, one of our main priorities is the privacy of our
    visitors.
  </p>
  <p>
    This Privacy Policy document contains types of information that is collected
    and recorded by dropzone.dev and how we use it.
  </p>
</Intro>
...
<ContentSection backgroundColor="white">
  ...
  <p>
    ...
    and/or collect in dropzone.dev. This policy is not applicable to any
  ...
  <p>
    dropzone.dev follows a standard procedure of using log files. These files
  ...
  <p>
    ...
    advertising partners of dropzone.dev.
  </p>

  <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on dropzone.dev, which are sent directly to users'
  ...
  <p>
    Note that dropzone.dev has no access to or control over these cookies that
  ...
  <p>
    dropzone.dev's Privacy Policy does not apply to other advertisers or
  ...
  <p>
    dropzone.dev does not knowingly collect any Personal Identifiable
