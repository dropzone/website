...
<Intro title="Privacy Policy for Dropzone">
  <p>
    At Dropzone, accessible at https://www.dropzone.dev and https://plus.dropzone.dev, one of our
  ...
  <p>
    ...
    dropzone.dev and how we use it.
  </p>
</Intro>
...
<ContentSection backgroundColor="white">
  ...
  <p>
    ...
    website with regards to the information that they shared and/or collect in dropzone.dev. This
  ...
  <p>
    dropzone.dev follows a standard procedure of using log files. These files log visitors when they
  ...
  <p>
    ...
    that are used in their respective advertisements and links that appear on dropzone.dev, which
  ...
  <p>
    Note that dropzone.dev has no access to or control over these cookies that are used by
  ...
  <p>
    dropzone.dev's Privacy Policy does not apply to other advertisers or websites. Thus, we are
  ...
  <p>
    dropzone.dev does not knowingly collect any Personal Identifiable Information from children
